...
if(!empty($_FILES['fileToUpload']['name'])){
    ...
    $upload_img = cwUpload('fileToUpload','uploads/','',TRUE,'uploads/','100','100');
...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        ...
        $query="INSERT INTO image(image,image_name) VALUES('{$imagetmp}','{$target_file}')";
        $result=mysql_query($query,$connection);
        if(!$result)
			die("Query Issue".mysql_error());
		thumbnailImage($imagetmp);
